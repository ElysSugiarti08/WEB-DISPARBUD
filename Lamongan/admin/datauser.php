...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="datauser.php">Data User</a>
        <!-- User -->
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $row["ket_jk"]; ?></td>
                    <td><?= $row["noTelp"]; ?></td>
                    <td><?= $row["ket_usertype"]; ?></td>
                    <td>
                      <div>
                        <a class="btn btn-sm" href="ubahuser.php?id=<?= $row["id_user"]; ?>">
                          Edit
                        </a>
                        <a class="btn btn-sm" href="hapususer.php?id=<?= $row["id_user"]; ?>" onclick="return confirm('Yakin mau menghapus user ?')">
                          Hapus
                        </a>
                      </div>
                    </td>
