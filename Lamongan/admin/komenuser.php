...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="komenuser.php">Data Komentar</a>
        <!-- User -->
        ...
        <div class="col">
          ...
          <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Data Komentar User</h3>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $row["isi_komen"]; ?></td>
                    <td><?= $row["email_komen"]; ?></td>
                    <td>
                      <div>
                        <a class="btn btn-sm" href="hapuskomen.php?id=<?= $row["id_komen"]; ?>" onclick="return confirm('Yakin mau menghapus komentar ?')">
                          Hapus
                        </a>
                      </div>
                    </td>
